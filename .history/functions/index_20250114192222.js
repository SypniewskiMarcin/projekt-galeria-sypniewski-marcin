...
const corsOptions = {
  origin: [
    ...
    // Dodaj dodatkowe domeny jeśli są potrzebne
  ],
...
exports.enhanceImage = onRequest({
  ...
  if (corsOptions.origin.includes(origin)) {
    ...
    response.set("Access-Control-Allow-Origin", corsOptions.origin[0]); // domyślnie localhost
  }
...
// Endpoint w Express do ulepszania obrazu
app.post("/enhance", corsMiddleware, async (req, res) => {
  try {
